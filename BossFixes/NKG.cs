...
namespace PantheonOfRegions.Behaviours
{
    internal class NightmareKingGrimm : MonoBehaviour
    {
        ...
        private void Start()
        {
            _Zote = GameObject.Find("Grey Prince(Clone)(Clone)");
            ...
            _control.InsertCustomAction("Balloon?", () => {
                sharedhp = GameObject.Find("reapers").GetComponent<SharedHealthManager>().HP;
            ...
            _control.InsertCustomAction("Adjust HP", () => {
                GameObject.Find("reapers").GetComponent<SharedHealthManager>().HP -= _control.Fsm.GetFsmInt("Bat Damage").Value;
            }, 0);
        }
